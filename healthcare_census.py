...
def main():
	states_to_add = ['0400000US01','0400000US02','0400000US04','0400000US05','0400000US06','0400000US08', # US State codes
	...
	column_names = ["IDX", "ST", "OC", "RC", "HICOV", "HINS4", "FPARC", "NOP", "CIT", "AGEP", "WGTP", "PWGTP"] # Desired PUMS codes
	...
	censusdf_2016 = pd.DataFrame([np.arange(0,12)], columns = column_names) # Initialize 2016 dataframe with throwaway row
	for i, state in enumerate(states_to_add): # For each state
